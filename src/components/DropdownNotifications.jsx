          ...
          <ul>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800">New Community</span> Sakshat Gandhi has proposed to form a new community private to the E-Commerce Startups.</span>
                <span className="block text-xs font-medium text-slate-400">Mar 19, 2023</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800">New Forum Post</span> Prof. Sucheta Kolekar is planning to revise the category of all the active startups </span>
                <span className="block text-xs font-medium text-slate-400">Mar 16, 2023</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">🚀<span className="font-medium text-slate-800">New Feed Post</span> Accelth recieved a recognition from Google and Microsoft Startup Programs.</span>
                <span className="block text-xs font-medium text-slate-400">Mar 4, 2023</span>
              </Link>
            </li>
          </ul>
        </div>
